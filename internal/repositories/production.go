...
type ProductRepository interface {
	...
	ListProducts(ctx context.Context, page, pageSize int) ([]*models.Product, int64, error)
...
// ListProducts 获取产品列表
func (r *ProductRepositoryImpl) ListProducts(ctx context.Context, page, pageSize int) ([]*models.Product, int64, error) {
